...
// ==/UserScript==
const t="@pickme/auth-widget",e=document.createElement("div");e.id=t,e.style.position="fixed",e.style.top="0",e.style.right="0",e.style.zIndex="99999",document.body.appendChild(e);const n=document.createElement("script");n.type="module",n.textContent=`\n    import { parcel } from "https://daily1hour.github.io/PickMe-Auth-Parcel/parcel.js";\n    const { bootstrap, mount } = parcel;\n\n    const container = document.getElementById('${t}');\n\n    bootstrap().then(() => {\n        mount({ name: "app1", domElement: container });\n    });\n`,document.body.appendChild(n);
